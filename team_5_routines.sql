...
--
-- Dumping routines for database 'team_5'
--
/*!50003 DROP PROCEDURE IF EXISTS `spGETCLIENTX` */;
...
/*!50003 DROP PROCEDURE IF EXISTS `spGETCLIENTX_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `spRISK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`2012669`@`%` PROCEDURE `spRISK`(pubnb char(3), arr time, dt text)
BEGIN
...
WHERE pe.client_id IN 
	(SELECT w.client_id 
    FROM weekend AS w 
    WHERE w.pub_id LIKE pubnb 
    AND w.arrived BETWEEN arr AND '22:30' 
    AND w.date LIKE dt);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2021-12-15 17:08:13
